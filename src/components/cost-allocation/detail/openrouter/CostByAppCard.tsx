...
const REGION_DATA: AppCostItem[] = [
  { name: 'us-east-1 (Primary Gateway)', cost: 4820.20, share: 59.9, barColor: 'bg-[#ff781f]' },
  { name: 'eu-west-1 (Secondary Failover)', cost: 1920.00, share: 23.9, barColor: 'bg-[#0070f3]' },
  { name: 'ap-south-1 (Regional Proxy)', cost: 1309.20, share: 16.2, barColor: 'bg-[#8b5cf6]' },
];

export function CostByAppCard() {
  ...
  return (
    <div className="rounded-xl border border-dark-border bg-dark-card/90 p-4 sm:p-5 flex flex-col justify-between shadow-sm h-full">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-dark-border/60">
        <h3 className="text-sm font-semibold text-white tracking-tight">Cost by Region</h3>
