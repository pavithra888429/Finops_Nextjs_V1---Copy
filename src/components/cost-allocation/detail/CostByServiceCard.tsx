...
const SERVICE_DATA: ServiceCostItem[] = [
  { name: 'Amazon EKS', cost: 3420.80, share: 42.5, change: 19.2, barColor: 'bg-[#ff781f]' },
  { name: 'Amazon EC2', cost: 2180.40, share: 27.1, change: 8.4, barColor: 'bg-[#0070f3]' },
  { name: 'Amazon RDS', cost: 1240.20, share: 15.4, change: 12.1, barColor: 'bg-[#8b5cf6]' },
  { name: 'Amazon S3', cost: 620.00, share: 7.7, change: 3.2, barColor: 'bg-[#00e599]' },
  { name: 'Other', cost: 588.00, share: 7.3, change: -2.1, barColor: 'bg-slate-600' },
];

export function CostByServiceCard() {
  ...
  return (
    <div className="rounded-xl border border-dark-border bg-dark-card/90 p-4 sm:p-5 flex flex-col justify-between shadow-sm h-full">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-dark-border/60">
        <h3 className="text-sm font-semibold text-white tracking-tight">Cost by AWS Service</h3>
        ...
        {SERVICE_DATA.map((item) => (
          <div key={item.name} className="space-y-1">
            <div className="grid grid-cols-12 gap-2 items-center text-xs">
              ...
              {/* Change */}
              <div className="col-span-2 flex items-center justify-end gap-0.5 text-right font-medium">
                {item.change >= 0 ? (
