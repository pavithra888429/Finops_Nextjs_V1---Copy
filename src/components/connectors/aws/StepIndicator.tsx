...
const STEPS = [
  { id: 1, label: "Configure AWS account" },
  { id: 2, label: "Configure Cloud Cost" },
  { id: 3, label: "Connection Progress" },
];

export function StepIndicator({ currentStep }: StepIndicatorProps) {
  return (
    <nav aria-label="Setup progress" className="mb-8 w-full">
      <ol className="flex items-center justify-between max-w-3xl mx-auto w-full">
